...
BB8Driver.prototype.start = function (callback) {
    console.log("BB8Driver.start", callback.toString());
    callback();
};

BB8Driver.prototype.halt = function (callback) {
    console.log("BB8Driver.halt", callback.toString());
    callback();
};
...
BB8Driver.prototype.setTXPower = function (level, callback) {
    Logger.info("BB8Driver.setTXPower (level)", level);
...
BB8Driver.prototype.setRGB = function (color, persist, callback) {
    Logger.info("BB8Driver.setRGB (color,persist)", color, persist);
...
BB8Driver.prototype.roll = function (speed, heading, state, callback) {
    Logger.info("BB8Driver.roll (speed,heading,state)", speed, heading, state);
...
BB8Driver.prototype.devModeOn = function (callback) {
    Logger.info("BB8Driver.devModeOn");
    var bb8 = this;
